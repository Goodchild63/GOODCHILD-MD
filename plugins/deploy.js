...
✞ Open this link 👉 https://goodchild-pairing-site-1.onrender.com then tap on pair code.
...
✞ After a successful login goodchild Md owner 😂 goodchild will send you a *session id* .some will wonder where the hell is that session ,,,...It is just right at your inbox /dm {your own number for whatsappp} 😂
✞Copy the Session id {the one with unreadable codes and long copy it and send it to your deployer or deploy
     *ʜᴏᴡ ᴛᴏ ᴅᴇᴘʟᴏʏ GOODCHILD ᴍᴅ*
